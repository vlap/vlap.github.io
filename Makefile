...
.PHONY: help sync build serve deploy watch fetch-web-stats
...
help:
	...
	@echo "  fetch-web-stats  Fetch external web stats (Scholar, GitHub, ORCID)"
...
fetch-web-stats:
	...
	@$(PYTHON) scripts/fetch_scholar.py || true
	@echo "==> Fetching GitHub activity..."
	@$(PYTHON) scripts/fetch_github.py || true
	@echo "==> Fetching ORCID data..."
	@$(PYTHON) scripts/fetch_orcid.py || true
